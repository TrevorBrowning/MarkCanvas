    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <div class="flex justify-between items-center mb-2">
          <label class="text-lg font-medium text-gray-800 dark:text-gray-300">Markdown Input</label>
        ...
        <textarea
          ...
          class="w-full h-96 rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-cyan-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 transition-colors resize-none"
        ></textarea>
        <div class="text-right text-sm mt-2 space-x-4 text-gray-700 dark:text-gray-400">
      ...
      <div
        v-html="renderedHtml"
        class="prose max-w-none overflow-y-auto h-96 rounded-lg border border-gray-300 bg-gray-50 p-4 text-gray-900 dark:prose-invert dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 transition-colors"
      ></div>
    </div>
    <div
    ...
    >
      ...
      >
        ...
        <div v-if="activeCheatSheetTab === 'basic'">
          ...
          <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <li><code class="bg-gray-200 px-1 rounded dark:bg-gray-700">* Unordered item</code></li>
            <li><code class="bg-gray-200 px-1 rounded dark:bg-gray-700">1. Ordered item</code></li>
          </ul>
          ...
          <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <li>
              <code class="bg-gray-200 px-1 rounded dark:bg-gray-700">![Alt Text](image.jpg)</code>
            </li>
          </ul>
          ...
          <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <li><code class="bg-gray-200 px-1 rounded dark:bg-gray-700">&gt; Blockquote</code></li>
          </ul>
        </div>
